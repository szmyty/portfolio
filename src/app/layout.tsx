...
export default async function RootLayout({
  ...
  return (
    ...
    >
      <head>
        {/* Favicon set generated by RealFaviconGenerator (v=20260412) */}
        <link rel="icon" type="image/png" href="/favicon-96x96.png?v=20260412" sizes="96x96" />
        <link rel="icon" type="image/svg+xml" href="/favicon.svg?v=20260412" />
        <link rel="shortcut icon" href="/favicon.ico?v=20260412" />
        <link rel="apple-touch-icon" sizes="180x180" href="/apple-touch-icon.png?v=20260412" />
