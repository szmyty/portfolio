  ...
  const mobileActions = (
    <div className="flex flex-wrap items-center justify-between gap-3">
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="inline-flex min-h-11 items-center gap-2 rounded-full border border-border bg-surface-overlay px-4 text-sm font-medium text-text-primary transition-colors hover:bg-surface-raised hover:text-accent"
        aria-label={t("repositoryLink")}
      >
        <GitHubMark />
